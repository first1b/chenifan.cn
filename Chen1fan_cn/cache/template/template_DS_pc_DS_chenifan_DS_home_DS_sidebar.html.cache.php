 <div class="sidebar col-xs-12 col-sm-4 col-md-4"> 
   <div class="widget widget_suxingme_postlist"> 
    ...
    <ul class="recent-posts-widget">
     ...
     <li class="others ">
      <div class="image ">
       <a href="<?php echo $t['url']; ?>" target="_blank " title=" <?php echo $t['title']; ?>"><img data-original=" <?php echo dr_thumb($t['thumb'], 200, 200); ?>" alt=" <?php echo $t['title']; ?>" class="thumbnail lazy " /></a>
      </div>
      <div class="title ">
   ...
   <div class="widget widget_suxingme_hotpost ">
    ...
    <ul class="widget_suxingme_post ">
      <?php $list_return = $this->list_tag("action=module module=article order=hits num=3"); if ($list_return && is_array($list_return)) extract($list_return, EXTR_OVERWRITE); $count=dr_count($return); if (is_array($return)) { $key=-1; foreach ($return as $t) { $key++; $is_first=$key==0 ? 1 : 0;$is_last=$count==$key+1 ? 1 : 0; ?> 
   ...
   <div class="widget suxingme_tag ">
    ...
    <div class="widge_tags ">
     <div class="tag - items ">
   <?php $list_return_t2 = $this->list_tag("action=tag num=20 order=hits  return=t2"); if ($list_return_t2 && is_array($list_return_t2)) extract($list_return_t2, EXTR_OVERWRITE); $count_t2=dr_count($return_t2); if (is_array($return_t2)) { $key_t2=-1;  foreach ($return_t2 as $t2) { $key_t2++; $is_first=$key_t2==0 ? 1 : 0;$is_last=$count_t2==$key_t2+1 ? 1 : 0; ?>
<a href="<?php echo $t['url']; ?>" title="<?php echo $t['name']; ?>"><?php echo $t2['name']; ?></a>
<?php } } ?>
      <a href=""></a> 
     </div>
    </div>
